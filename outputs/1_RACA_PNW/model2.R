...
# 79 observations, 1.5 median visits per site
for (j in 1:nV7) {
...
# 59 observations, 2 median visits per site
for (j in 1:nY8) {
...
# 751 observations, 5 median visits per site
for (j in 1:nY9) {
...
# 65 observations, 1 median visits per site
for (j in 1:nY10) {
