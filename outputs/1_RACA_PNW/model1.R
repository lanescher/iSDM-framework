...
# 58 observations, 1 median visits per site
for (j in 1:nV7) {
...
# 56 observations, 2 median visits per site
for (j in 1:nY8) {
...
# 180 observations, 11 median visits per site
for (j in 1:nY9) {
...
# 49 observations, 1 median visits per site
for (j in 1:nY10) {
