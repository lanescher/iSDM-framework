...
# 85 observations, 2 median visits per site
for (j in 1:nV7) {
...
# 37 observations, 2 median visits per site
for (j in 1:nY8) {
...
# 658 observations, 5 median visits per site
for (j in 1:nY9) {
...
# 67 observations, 1 median visits per site
for (j in 1:nY10) {
