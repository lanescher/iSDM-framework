...
# 107 observations, 1 median visits per site
for (j in 1:nY4) {
...
# Observation Model 6: count, Bailey
...
# Observation Model 7: count, Dodd Terrestrial
...
# Observation priors, count 6: Bailey
for (b in 1) {
  C6[b] ~ dnorm(0,1)
}

# Observation priors, count 7: Dodd Terrestrial
for (b in 1:nCovY7) {
  C7[b] ~ dnorm(0,1)
}
