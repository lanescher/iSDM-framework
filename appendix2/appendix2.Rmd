...
The following table describes the column names, data type, and description
# FINISH TABLE
...
# THEN WE COULD REMOVE 'A' BELOW AND FIX IT AT 1 - DO THIS
...
MOVE SPECIES CODE ETC FROM BELOW HERE
