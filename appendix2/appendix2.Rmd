...
<!-- outplot <- plot_chains(samples, data = data, constants = constants, cov.labs = cov.labs, -->
<!--                        plot = "alpha", cutoff = 0) -->
<!-- ggsave(outplot$plot, -->
<!--        file = paste0(out.dir, "3_parameters-b1_chains-alpha.jpg"), -->
<!--        height = 6, width = 8) -->

<!-- outplot <- plot_posteriors(samples, data = data, constants = constants, cov.labs = cov.labs, -->
<!--                            plot = "alpha", cutoff = 0) -->
<!-- ggsave(outplot, -->
...
<!-- outplot <- map_species_data(title = "Lambda, mean estimate", region = region, plot = "lambda", -->
<!--                             out = out, -->
...
<!-- outplot <- map_species_data(title = "Lambda, relative uncertainty", region = region, plot = "lambda", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
...
<!-- outplot <- map_species_data(title = "Log(lambda)", region = region, plot = "lambda", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
...
<!-- outplot <- map_species_data(title = "Psi, mean estimate", region = region, plot = "psi", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
<!--                             transform = "none", plot.change = F) -->
...
<!-- outplot <- map_species_data(title = "Boundary, threshold = 0.75", region = region, plot = "boundary", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
<!--                             transform = "none", plot.change = F, -->
...
<!-- # Spatial effect -->
<!-- outplot <- map_species_data(title = "Spatial effect, mean estimate", region = region, plot = "spat", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
<!--                             transform = "none", plot.change = F) -->
...
<!-- outplot <- map_species_data(title = "XB, mean estimate", region = region, plot = "XB", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
<!--                             transform = "none", plot.change = F) -->
...
<!-- # Effort -->
<!-- outplot <- map_species_data(title = "Effort, mean estimate", region = region, plot = "effort", -->
<!--                             out = out, -->
<!--                             plot.range = F, plot.region = F, plot.cells = F, -->
<!--                             plot.current = T, plot.uncertainty = F, -->
<!--                             transform = "none", plot.change = F) -->
...
<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-a_lambda.jpg) -->


<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-a_lambda-relunc.jpg) -->


<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-a_lambdalog.jpg) -->


<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-b_psi.jpg) -->

<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-c_boundary.jpg) -->


<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-d_spat.jpg) -->


<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-e_xb.jpg) -->

<!-- ![Map of relative intensity](~/GitHub/iSDM-framework/outputs/3_RACA_subrange/4_mapcurrent-f_effort.jpg) -->
