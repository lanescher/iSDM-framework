...
# External path for large datasets
...
<!--                       cov.labs = covlabs, -->
<!--                       scaled = T) -->
<!--     ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-b_POinat-map.jpg")) -->

<!--     if (length(covs.inat) > 1) { -->
<!--       out <- cor_covar(covar,  -->
<!--                        cov.labs = covlabs, -->
<!--                        color.threshold = 0.25) -->
<!--       ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-b_POinat-cors.jpg")) -->
<!--     } -->
<!--   } -->
...
<!--                     cov.labs = covlabs, -->
<!--                     scaled = T) -->
<!--   ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-c_PO-map.jpg")) -->

<!--   if (length(covs.PO) > 1) { -->
<!--     out <- cor_covar(covar,  -->
<!--                      cov.labs = covlabs, -->
<!--                      color.threshold = 0.25) -->
<!--     ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-c_PO-cors.jpg")) -->
<!--   } -->
<!-- } -->
<!-- ``` -->
