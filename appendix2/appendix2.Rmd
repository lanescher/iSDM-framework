...
if (fold.out == "none") {
  ...
  out <- plot_covar(covar,
                    ...
                    cov.labs = covlabs,
                    scaled = T)
  ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_process-map.jpg"))
  
  out <- cor_covar(covar, 
                   cov.labs = covlabs,
                   color.threshold = 0.25)
  ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_process-cors.jpg"))
  ...
  if ("iNaturalist" %in% names(species.data$obs)) {
    ...
    out <- plot_covar(covar,
                      ...
                      cov.labs = covlabs,
                      scaled = T)
    ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_POinat-map.jpg"))
    
    if (length(covs.inat) > 1) {
      out <- cor_covar(covar, 
                       cov.labs = covlabs,
                       color.threshold = 0.25)
      ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_POinat-cors.jpg"))
    }
  }
  ...
  out <- plot_covar(covar,
                    ...
                    cov.labs = covlabs,
                    scaled = T)
  ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_PO-map.jpg"))
  
  if (length(covs.PO) > 1) {
    out <- cor_covar(covar, 
                     cov.labs = covlabs,
                     color.threshold = 0.25)
    ggsave(out$plot, height = 12, width = 12, file = paste0(out.dir, "1_covariates-a_PO-cors.jpg"))
  }
}
```
